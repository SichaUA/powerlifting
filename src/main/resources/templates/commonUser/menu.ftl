    ...
    <aside>
        <div id="sidebar" class="nav-collapse ">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <#else>
                    <p class="centered"><img src="/img/avatars/${user.photo}" class="img-circle" width="60"></p>
...
<#if user??>
<script type="application/javascript" src="/js/commonUser/menu.js"></script>
</#if>
