...
<body>
                    ...
                    <div class="form-panel">
                        <form class="form-horizontal style-form" id="user-form" data-bind="submit: newUser">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="password"  class="form-control" placeholder="" data-bind="value: confirmPassword">
                                </div>
                            </div>
    ...
    <script type="application/javascript" src="/js/commonUser/sign-up.js"></script>
