                ...
                <div class="form-panel">
                    <form class="form-horizontal style-form" id="participant-form" data-bind="submit: newParticipant">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <label>
                                    <input id="addJudgeToCompetition" type="checkbox" checked data-bind="checked: addJudgeToCompetition"/> Add user to competition
                                </label>
                            </div>
                        </div>
...
<script type="application/javascript" src="/js/moderator/createNewUser.js"></script>
